...
export default function SignatureGenerator() {
  ...
  const generateSignature = async () => {
    ...
    try {
                ...
                <tr>
                  <td style="vertical-align: top; padding-right: 15px; width: 80px; height: 80px;">
                    ${
                      ...
                      <div style="width: 80px; height: 80px; ">
                        <img src="${formData.imageUrl}" width="80px" height="80px" style="width: 80px; height: 80px;">
                      </div>
                    `
                        : ""
                    }
                  ...
                  <td style="vertical-align: top;">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="line-height: 1.2;">
                      ...
                      <tr>
                        <td style="padding-bottom: 2px;">
                          <span style="font-size: 14px;">${formData.phone}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 2px;">
                          <a href="mailto:${formData.email}" style="color: #0066cc; text-decoration: none; font-size: 14px;">${formData.email}</a>
                        </td>
                      </tr>
                      <tr>
                        <td>
      ...
      if (tabsRef.current) {
        const previewTab = tabsRef.current.querySelector('[data-state="active"]') as HTMLElement
        if (previewTab) {
          previewTab.click()
        }
      }
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab} ref={tabsRef}>
            ...
            <TabsContent value="form" className="space-y-4">
              ...
              <Button onClick={generateSignature} className="w-full" disabled={isLoading}>
              ...
              {signature.html && (
                <>
                  ...
                  <div className="border p-4 rounded-lg">
                    <div ref={signatureRef} dangerouslySetInnerHTML={{ __html: signature.html }} />
                  </div>
